...
// respect them. Otherwise, we leave the option unset so the server can apply
// the model's persisted default or its own capability-based fallback without
// the CLI overriding it.
