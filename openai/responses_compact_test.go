...
func TestCompactionTrimPreservesProtectedState(t *testing.T) {
	body := []byte(`{"model":"test","input":[
		...
		{"type":"tool_search_call","call_id":"old","execution":"client","status":"completed","arguments":{"query":"find a tool"}},
		{"type":"tool_search_output","call_id":"old","execution":"client","status":"completed","tools":[{"type":"namespace","name":"example","tools":[{"type":"function","name":"shell","description":"` + strings.Repeat("old output ", 1000) + `","parameters":{"type":"object"}}]}]},
